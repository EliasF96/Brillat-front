...
import logo from "./img/brillat-logo.svg"
import link1 from "./img/ig-post1.jpg"
import link2 from "./img/ig-post2.jpg"
const Footer = () => {
  return (
    <footer>
      <div className="footerContainer">
        <div className="info1">
          ...
          <div className="icons">
            ...
            <a href="https://www.facebook.com/BrillatSavarinmza/?locale=es_LA" target="_blank" rel="noopener noreferrer">
